  ...
  return (
    <div className="flex">
      <Dropdown
        ...
        value={(data.machineMatrix&&data.machineMatrix[i]&&data.machineMatrix[i][j])?data.machineMatrix[i][j]:''}
        options={(isOutputItem)?getStatesOptions(data.outputAlphabet):getStatesOptions(data.states)}
