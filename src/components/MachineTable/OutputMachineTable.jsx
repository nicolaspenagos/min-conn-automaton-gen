  ...
  const renderTableHeader = () => {
    ...
    return (
      <tr>
        ...
        <th className={machine.type===MEALY?'hidden border-t-0 border-b-0 border-r-0  min-w-[80px] font-normal':'border-t-0 border-b-0 border-r-0 min-w-[80px] font-normal'}>Output</th>
      </tr>
    );
  };
